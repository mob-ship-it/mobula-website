  ...
  return (
    <section className="bg-[#faf1ea] py-16 md:py-20 lg:py-24">
      <div className="max-w-md mx-auto px-4">
        {/* Form Card - Centered like in the image */}
        <div className="bg-[#faf1ea] rounded-3xl p-8 md:p-10">
          <h3 className="[font-family:'Bricolage_Grotesque',Helvetica] font-semibold text-[#13243c] text-2xl md:text-3xl mb-8 text-center">
            Suscribirse
          </h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className={`
                w-full h-[56px] bg-[#211ee1] hover:bg-[#1a18c4] active:bg-[#151199]
