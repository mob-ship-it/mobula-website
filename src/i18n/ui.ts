...
export const ui = {
  ...
  'projects.cards.ecp.desc': 'Construimos la base de una marca premium y cercana.',
    ...
    // Brief Content Form
    'briefContent.form.title': 'Brief para creación de contenido',
    'briefContent.form.subtitle': 'Este brief nos ayuda a entender tu negocio, tus objetivos y la dirección esperada antes de iniciar.',
    'briefContent.form.section1': '1. Datos básicos',
    'briefContent.form.socialMedia': 'Redes sociales',
    'briefContent.form.location': 'Ubicación',
    'briefContent.form.section2': '2. Sobre el negocio',
    'briefContent.form.whatYouSell': '¿Qué vende u ofrece tu negocio?',
    'briefContent.form.mainProduct': '¿Cuál es tu producto o servicio principal?',
    'briefContent.form.whyChooseYou': '¿Por qué deberían elegir tu negocio?',
    'briefContent.form.section3': '3. Objetivo del proyecto',
    'briefContent.form.projectGoal': '¿Qué querés lograr con este proyecto?',
    'briefContent.form.section4': '4. Público objetivo',
    'briefContent.form.targetAudience': '¿A quién querés atraer?',
    'briefContent.form.audienceInterests': '¿Qué le importa más a ese público? (Seleccionar máximo 2)',
    'briefContent.form.section5': '5. Material disponible',
    'briefContent.form.availableMaterials': '¿Qué materiales tenés actualmente?',
    'briefContent.form.materialsLink': 'Link con materiales disponibles:',
    'briefContent.form.section6': '6. Estilo visual',
    'briefContent.form.visualStyleAction': '¿Qué querés hacer con el estilo actual de tu marca?',
    'briefContent.form.visualStyleLookingFor': 'Si querés cambiarlo o mejorarlo, ¿qué estilo buscás?',
    'briefContent.form.visualReferences': 'Compartí 2 referencias visuales que te gusten:',
    'briefContent.form.visualDislikes': '¿Hay algo visual que no te guste o querás evitar?',
    'briefContent.form.section7': '7. Tono de comunicación',
    'briefContent.form.toneOfVoice': '¿Cómo querés que suene tu marca? (Seleccionar máximo 2)',
    'briefContent.form.pronoun': '¿Tu marca habla de vos, tú o usted?',
    'briefContent.form.section8': '8. Solicitud del proyecto',
    'briefContent.form.needsToDevelop': '¿Qué necesitás desarrollar?',
    'briefContent.form.channels': 'Canales donde se usará:',
    'briefContent.form.formats': 'Formatos necesarios:',
    'briefContent.form.quantity': 'Cantidad aproximada de piezas:',
    'briefContent.form.deliveryDate': 'Fecha ideal de entrega:',
    'briefContent.form.section9': '9. Información adicional',
    'briefContent.form.additionalInfo': '¿Hay algo más que debamos saber antes de iniciar?',
    'briefContent.form.finalNote': 'Nota final: Si buscás un estilo diferente al actual, es importante compartir referencias antes de iniciar. Los cambios y ajustes se trabajarán con base en la información compartida en este brief.',
  },
  en: {
  ...
  'projects.cards.kasecab.title': 'KaseCab Americas',
    ...
    // Brief Content Form
    'briefContent.form.title': 'Brief for content creation',
    'briefContent.form.subtitle': 'This brief helps us understand your business, your goals, and the expected direction before starting.',
    'briefContent.form.section1': '1. Basic Information',
    'briefContent.form.socialMedia': 'Social media',
    'briefContent.form.location': 'Location',
    'briefContent.form.section2': '2. About the business',
    'briefContent.form.whatYouSell': 'What does your business sell or offer?',
    'briefContent.form.mainProduct': 'What is your main product or service?',
    'briefContent.form.whyChooseYou': 'Why should they choose your business?',
    'briefContent.form.section3': '3. Project goal',
    'briefContent.form.projectGoal': 'What do you want to achieve with this project?',
    'briefContent.form.section4': '4. Target audience',
    'briefContent.form.targetAudience': 'Who do you want to attract?',
    'briefContent.form.audienceInterests': 'What matters most to that audience? (Select up to 2)',
    'briefContent.form.section5': '5. Available material',
    'briefContent.form.availableMaterials': 'What materials do you currently have?',
    'briefContent.form.materialsLink': 'Link to available materials:',
    'briefContent.form.section6': '6. Visual style',
    'briefContent.form.visualStyleAction': 'What do you want to do with your brand\'s current style?',
    'briefContent.form.visualStyleLookingFor': 'If you want to change or improve it, what style are you looking for?',
    'briefContent.form.visualReferences': 'Share 2 visual references that you like:',
    'briefContent.form.visualDislikes': 'Is there anything visual that you don\'t like or want to avoid?',
    'briefContent.form.section7': '7. Tone of communication',
    'briefContent.form.toneOfVoice': 'How do you want your brand to sound? (Select up to 2)',
    'briefContent.form.pronoun': 'Does your brand speak as vos, tú, or usted?',
    'briefContent.form.section8': '8. Project request',
    'briefContent.form.needsToDevelop': 'What do you need to develop?',
    'briefContent.form.channels': 'Channels where it will be used:',
    'briefContent.form.formats': 'Required formats:',
    'briefContent.form.quantity': 'Approximate quantity of pieces:',
    'briefContent.form.deliveryDate': 'Ideal delivery date:',
    'briefContent.form.section9': '9. Additional information',
    'briefContent.form.additionalInfo': 'Is there anything else we should know before starting?',
    'briefContent.form.finalNote': 'Final note: If you are looking for a different style than your current one, it is important to share references before starting. Changes and adjustments will be worked on based on the information shared in this brief.',
  },
} as const;
